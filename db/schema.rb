...
ActiveRecord::Schema.define(version: 2021_12_11_204030) do
  ...
  create_table "takequizzes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["quiz_id"], name: "index_takequizzes_on_quiz_id"
    t.index ["user_id"], name: "index_takequizzes_on_user_id"
  end
